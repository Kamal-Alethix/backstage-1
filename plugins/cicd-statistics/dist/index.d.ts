 ...
 */
declare type FilterStatusType = 'unknown' | 'enqueued' | 'scheduled' | 'running' | 'aborted' | 'succeeded' | 'failed' | 'stalled' | 'expired';
 ...
 */
declare type FilterBranchType = 'master' | 'branch';
declare type TriggerReason = 
 ...
 */
declare type BuildWithRaw<T = any> = Build & {
    raw: T;
};
/**
 * Chart type.
 ...
 */
declare type ChartType = 'duration' | 'count';
declare type ChartTypes = Array<ChartType>;
/**
...
export { AbortError, Build, BuildWithRaw, ChartType, ChartTypes, CicdConfiguration, CicdDefaults, CicdState, CicdStatisticsApi, EntityCicdStatisticsContent, EntityPageCicdCharts, FetchBuildsOptions, FilterBranchType, FilterStatusType, GetConfigurationOptions, Stage, TriggerReason, UpdateProgress, cicdStatisticsApiRef, cicdStatisticsPlugin, statusTypes, triggerReasons };
