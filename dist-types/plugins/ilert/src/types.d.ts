...
export declare type IncidentStatus = typeof PENDING | typeof ACCEPTED | typeof RESOLVED;
export declare type IncidentPriority = 'HIGH' | 'LOW';
...
export declare type SubscriberType = 'TEAM' | 'USER';
...
export declare type UserRole = 'USER' | 'ADMIN' | 'STAKEHOLDER' | 'ACCOUNT_OWNER' | 'RESPONDER';
...
export declare type AlertSourceStatus = 'PENDING' | 'ALL_ACCEPTED' | 'ALL_RESOLVED' | 'IN_MAINTENANCE' | 'DISABLED';
export declare type AlertSourceIntegrationType = 'NAGIOS' | 'ICINGA' | 'EMAIL' | 'SMS' | 'API' | 'CRN' | 'HEARTBEAT' | 'PRTG' | 'PINGDOM' | 'CLOUDWATCH' | 'AWSPHD' | 'STACKDRIVER' | 'INSTANA' | 'ZABBIX' | 'SOLARWINDS' | 'PROMETHEUS' | 'NEWRELIC' | 'GRAFANA' | 'GITHUB' | 'DATADOG' | 'UPTIMEROBOT' | 'APPDYNAMICS' | 'DYNATRACE' | 'TOPDESK' | 'STATUSCAKE' | 'MONITOR' | 'TOOL' | 'CHECKMK' | 'AUTOTASK' | 'AWSBUDGET' | 'KENTIXAM' | 'CONSUL' | 'ZAMMAD' | 'SIGNALFX' | 'SPLUNK' | 'KUBERNETES' | 'SEMATEXT' | 'SENTRY' | 'SUMOLOGIC' | 'RAYGUN' | 'MXTOOLBOX' | 'ESWATCHER' | 'AMAZONSNS' | 'KAPACITOR' | 'CORTEXXSOAR' | string;
export declare type AlertSourceIncidentCreation = 'ONE_INCIDENT_PER_EMAIL' | 'ONE_INCIDENT_PER_EMAIL_SUBJECT' | 'ONE_PENDING_INCIDENT_ALLOWED' | 'ONE_OPEN_INCIDENT_ALLOWED' | 'OPEN_RESOLVE_ON_EXTRACTION';
export declare type AlertSourceFilterOperator = 'AND' | 'OR';
export declare type AlertSourceIncidentPriorityRule = 'HIGH' | 'LOW' | 'HIGH_DURING_SUPPORT_HOURS' | 'LOW_DURING_SUPPORT_HOURS';
...
export declare type AlertSourceTimeZone = 'Europe/Berlin' | 'America/New_York' | 'America/Los_Angeles' | 'Asia/Istanbul';
