 ...
 * @public
 */
export declare type TechInsightFact = {
    /**
 ...
 * @public
 */
export declare type FlatTechInsightFact = TechInsightFact & {
    /**
 ...
 * @public
 */
export declare type FactSchema = {
    /**
     * Name of the fact
     */
    [name: string]: {
 ...
 */
export declare type FactRetrieverContext = {
    config: Config;
 ...
 * @public
 */
export declare type FactLifecycle = TTL | MaxItems;
/**
 ...
 * @public
 */
export declare type FactSchemaDefinition = Omit<FactRetriever, 'handler'>;
/**
 ...
 * @public
 */
export declare type FactRetrieverRegistration = {
    /**
