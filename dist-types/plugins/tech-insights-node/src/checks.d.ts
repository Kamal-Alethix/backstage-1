 ...
 */
export interface FactCheckerFactory<CheckType extends TechInsightCheck, CheckResultType extends CheckResult> {
    /**
 ...
 * @typeParam CheckResultType - Implementation specific result of a check. Can extend CheckResult with additional information
 */
export interface FactChecker<CheckType extends TechInsightCheck, CheckResultType extends CheckResult> {
    /**
 ...
 * @public
 */
export declare type CheckValidationResponse = {
    valid: boolean;
    message?: string;
    errors?: unknown[];
};
