 ...
 * @public
 */
export declare type PublisherFactory = {
    logger: Logger;
 ...
 * @public
 */
export declare type PublisherType = 'local' | 'googleGcs' | 'awsS3' | 'azureBlobStorage' | 'openStackSwift';
/**
 ...
 * @public
 */
export declare type ReadinessResponse = {
 ...
 * @public
 */
export declare type MigrateRequest = {
    /**
