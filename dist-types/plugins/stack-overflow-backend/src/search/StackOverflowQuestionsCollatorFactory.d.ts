 ...
 * @public
 */
export declare type StackOverflowQuestionsCollatorFactoryOptions = {
    baseUrl?: string;
 ...
 * @public
 */
export declare class StackOverflowQuestionsCollatorFactory implements DocumentCollatorFactory {
