 ...
 * @public
 */
export declare type SearchResult = Result<SearchDocument>;
/**
 * @public
 */
export declare type SearchResultSet = ResultSet<SearchDocument>;
/**
 * @public
 */
export declare type IndexableResult = Result<IndexableDocument>;
/**
 * @public
 */
export declare type IndexableResultSet = ResultSet<IndexableDocument>;
/**
 ...
 * @public
 */
export declare type IndexableDocument = SearchDocument & {
    /**
 ...
 * @public
 */
export declare type DocumentTypeInfo = {
    /**
 ...
 * @public
 */
export declare type QueryTranslator = (query: SearchQuery) => unknown;
/**
 * Options when querying a search engine.
 * @public
 */
export declare type QueryRequestOptions = {
    token?: string;
};
/**
