 ...
 */
export declare type FilterStatusType = 'unknown' | 'enqueued' | 'scheduled' | 'running' | 'aborted' | 'succeeded' | 'failed' | 'stalled' | 'expired';
export declare const statusTypes: Array<FilterStatusType>;
/**
 ...
 */
export declare type FilterBranchType = 'master' | 'branch';
export declare type TriggerReason = 
...
/** Triggered for some other reason */
 | 'other';
export declare const triggerReasons: Array<TriggerReason>;
/**
 ...
 */
export declare type BuildWithRaw<T = any> = Build & {
    raw: T;
};
/**
 * Chart type.
 ...
 */
export declare type ChartType = 'duration' | 'count';
export declare type ChartTypes = Array<ChartType>;
/**
