 ...
 * @public
 */
export declare type AuthResolverCatalogUserQuery = {
    entityRef: string | {
        kind?: string;
        namespace?: string;
        name: string;
 ...
 * @public
 */
export declare type AuthResolverContext = {
 ...
 * @public
 */
export declare type CookieConfigurer = (ctx: {
 ...
 */
export declare type AuthProviderFactoryOptions = {
    providerId: string;
...
export declare type AuthProviderFactory = (options: {
    providerId: string;
    globalConfig: AuthProviderConfig;
    config: Config;
    logger: Logger;
...
/** @public */
export declare type AuthResponse<ProviderInfo> = {
 ...
 * @public
 */
export declare type SignInInfo<TAuthResult> = {
    /**
 ...
 * @public
 */
export declare type SignInResolver<TAuthResult> = (info: SignInInfo<TAuthResult>, context: AuthResolverContext) => Promise<BackstageSignInResult>;
/**
 ...
 * @public
 */
export declare type AuthHandlerResult = {
    profile: ProfileInfo;
};
/**
 ...
 * @public
 */
export declare type AuthHandler<TAuthResult> = (input: TAuthResult, context: AuthResolverContext) => Promise<AuthHandlerResult>;
/** @public */
export declare type StateEncoder = (req: OAuthStartRequest) => Promise<{
    encodedState: string;
}>;
