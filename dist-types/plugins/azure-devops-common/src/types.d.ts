...
export declare type RepoBuildOptions = {
    top?: number;
};
...
export declare type PullRequestOptions = {
    top: number;
    status: PullRequestStatus;
};
...
export declare enum PolicyTypeId {
    /**
...
export declare enum PullRequestVoteStatus {
    Approved = 10,
...
export declare type BuildRunOptions = {
    top?: number;
};
