import { Alert, Cost, Entity, Group, Project, Maybe, MetricData } from '../types';
export declare type ProductInsightsOptions = {
    /**
...
export declare type CostInsightsApi = {
    /**
...
export declare const costInsightsApiRef: import("@backstage/core-plugin-api").ApiRef<CostInsightsApi>;
