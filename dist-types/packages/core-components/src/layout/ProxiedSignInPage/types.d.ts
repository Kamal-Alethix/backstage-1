import { BackstageIdentityResponse, ProfileInfo } from '@backstage/core-plugin-api';
import { z } from 'zod';
export declare const proxiedSessionSchema: z.ZodObject<{
    providerInfo: z.ZodOptional<z.ZodObject<{}, "strip", z.ZodUnknown, {
        [x: string]: unknown;
    }, {
        [x: string]: unknown;
    }>>;
 ...
 * @public
 */
export declare type ProxiedSession = {
    providerInfo?: {
        [key: string]: unknown;
    };
    profile: ProfileInfo;
