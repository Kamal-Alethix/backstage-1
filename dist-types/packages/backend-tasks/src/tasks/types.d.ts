 ...
 * @public
 */
export declare type HumanDuration = {
    years?: number;
    months?: number;
    weeks?: number;
    days?: number;
 ...
 * @public
 */
export declare type TaskFunction = ((abortSignal: AbortSignal) => void | Promise<void>) | (() => void | Promise<void>);
/**
...
export declare const taskSettingsV1Schema: z.ZodObject<{
    version: z.ZodLiteral<1>;
    initialDelayDuration: z.ZodEffects<z.ZodOptional<z.ZodString>, string | undefined, string | undefined>;
    recurringAtMostEveryDuration: z.ZodEffects<z.ZodString, string, string>;
    timeoutAfterDuration: z.ZodEffects<z.ZodString, string, string>;
}, "strip", z.ZodTypeAny, {
    initialDelayDuration?: string | undefined;
    version: 1;
    recurringAtMostEveryDuration: string;
 ...
 */
export declare type TaskSettingsV1 = z.infer<typeof taskSettingsV1Schema>;
export declare const taskSettingsV2Schema: z.ZodObject<{
    version: z.ZodLiteral<2>;
    cadence: z.ZodUnion<[z.ZodEffects<z.ZodString, string, string>, z.ZodEffects<z.ZodString, string, string>]>;
    timeoutAfterDuration: z.ZodEffects<z.ZodString, string, string>;
    initialDelayDuration: z.ZodEffects<z.ZodOptional<z.ZodString>, string | undefined, string | undefined>;
}, "strip", z.ZodTypeAny, {
    initialDelayDuration?: string | undefined;
 ...
 */
export declare type TaskSettingsV2 = z.infer<typeof taskSettingsV2Schema>;
