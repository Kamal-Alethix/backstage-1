...
import { AnyApiFactory, AppTheme, IconComponent, BackstagePlugin, RouteRef, SubRouteRef, ExternalRouteRef, IdentityApi } from '@backstage/core-plugin-api';
 ...
 * @public
 */
export declare type AppConfigLoader = () => Promise<AppConfig[]>;
/**
 ...
 * @public
 */
export declare type AppRouteBinder = <ExternalRoutes extends {
    [name: string]: ExternalRouteRef;
 ...
 * @public
 */
export declare type BackstageApp = {
    /**
